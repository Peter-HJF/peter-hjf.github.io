...
<body>
	   ...
	   <div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarresponsive">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item"><a href="contact.php" class="nav-link active">Contacte-nos</a></li>
			</ul>
		</div>
	   </div>
    </nav>
	...
	<section id="newsletter">
			<div class="container">
				<div class="row justify-content-center">
					<div class="col-md-8">
					  <h3>Receba as ultimas novidades do setor</h3>
				...
				<div class="row justify-content-center">
					<div class="col-md-8">
					  <form action="" method="">
						  <input type="email" name="email" placeholder="Introduza o seu Email"><input type="submit" value="Subscrever">
					  </form>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-7">
					<div class="section-title">
						<h2 class="text-dark"><b>Contacte-nos</b></h2>
						<p class="text-secondary"><b>Lorem ipsum dolor sit</b> consectetur adipiscing morbi venenatis et tortor consectetur adipisicing lacinia tortor morbi ultricies</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-7">
					<form action="thanks.php" method="POST" class="mb-4 mb-lg-0">
						<div class="form-row">
							<div class="col-md-6 form-group">
								<input type="text" name="name" class="form-control border border-success" id="name" placeholder="Nome" />
							</div>
							<div class="col-md-6 form-group">
								<input type="email" class="form-control border border-success" name="email" id="email" placeholder="Email" />
							</div>
						</div>
						<div class="form-group">
							<input type="text" class="form-control border border-success" name="subject" id="subject" placeholder="Assunto" />
						</div>
						<div class="form-group">
							<textarea class="form-control border border-success" name="message" placeholder="Escreva a mensagem"></textarea>
						</div>
						<button type="submit" class="btn btn-success rounded-pill">Enviar <i class="fas fa-paper-plane"></i></button>
						</i>
					</form>
				</div>

				<div class="col-lg-5">
					<div class="map border border-secondary">
						<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3180.180592265856!2d-8.539209384700266!3d37.14840517987831!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd1ad16e99123de9%3A0x91f17c35d351cadd!2sIEFP%20-%20Instituto%20do%20Emprego%20e%20Forma%C3%A7%C3%A3o%20Profissional!5e0!3m2!1spt-PT!2spt!4v1605457865221!5m2!1spt-PT!2spt" width="100%" height="350" frameborder="0" style="border: 0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Widget Jovichat -->
	<script src="//code.jivosite.com/widget/kla76xOrJ4" async></script>
